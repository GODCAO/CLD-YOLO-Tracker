...
from ultralytics.utils.torch_utils import (
    ...
    select_device,
    strip_optimizer,
    torch_distributed_zero_first, unwrap_model,
)
...
class BaseTrainer:
    ...
    #     elif name == "MuSGD":
    #         optimizer = MuSGD(
    #             g[2], lr=lr, momentum=momentum, nesterov=True, muon=True,
    #             muon=0.5 if iterations > 10000 else 0.1,
    #             sgd=0.5 if iterations > 10000 else 1.0,
    #         )
    #     else:
